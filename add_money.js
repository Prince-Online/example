const username = localStorage.getItem('name_local');
if (!username) {
    alert('Please Login First!');
}

const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzwqJz4pYkt_Fo_j4aSua-7K7ZhO3pbGfnHRGvbrewsNUpdihGebvDQVArhCVxZdUcJoA/exec';
...
async function uploadToImgur(file) {
    ...
    const response = await fetch('https://api.imgur.com/3/image', {
        method: 'POST',
        headers: {
            'Authorization': 'Client-ID 1e158eed6ba4fcc'
        },
        body: formData
    });
